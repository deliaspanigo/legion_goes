...
git commit -m "Release v0.0.2: Implementación de orquestadores y scripts de ejecución Bash"

# 3. Crear la etiqueta (Tag) oficial de la versión
git tag -a v0.0.2 -m "Versión inicial funcional de la factoría Legion GOES"
