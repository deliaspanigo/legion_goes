...
Sentence: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f03_run_day_hour.ABI_L2_LSTF.day_hour_ABI_L2_LSTF_fnp01
...
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_LSTF.runner_ABI_L2_LSTF import run_runner_ABI_L2_LSTF_fnp01
...
def run_day_hour_ABI_L2_LSTF_fnp01(position: str, year: str, day: str, hour: str):
    ...
    product_id = "ABI-L2-LSTF"  # Corregido a guion medio para coincidir con la carpeta
