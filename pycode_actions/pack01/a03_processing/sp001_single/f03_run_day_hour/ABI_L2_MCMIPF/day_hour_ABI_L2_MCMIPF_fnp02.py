...
Sentence: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f03_run_day_hour.ABI_L2_MCMIPF.day_hour_ABI_L2_MCMIPF_fnp02
...
if __name__ == "__main__":
    print("\n" + " FNP02: LSTF RUNNER (MULTI-HOUR) ".center(80, "="))
