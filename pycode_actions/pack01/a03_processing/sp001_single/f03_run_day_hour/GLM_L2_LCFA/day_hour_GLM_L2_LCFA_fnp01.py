"""
Path: legion_goes/pycode_actions/pack01/a03_processing/sp001_single/f03_run_day_hour/GLM_L2_LCFA/day_hour_GLM_L2_LCFA_fnp01.py
...
"""
# ================================================================================================================================================
#  Execution: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f03_run_day_hour.GLM_L2_LCFA.day_hour_GLM_L2_LCFA_fnp01
# ================================================================================================================================================
...
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.GLM_L2_LCFA.runner_GLM_L2_LCFA_fnp01 import run_runner_GLM_L2_LCFA_fnp01

def run_day_hour_GLM_L2_LCFA_fnp01(position: str, year: str, day: str, hour: str, overwrite = False):
    """
    Processes all GLM_L2_LCFA files for a specific day/hour or an entire day.
    """
    # GLM_L2_LCFA
    
    # 1. Identify Satellite and Product
    sat_id = get_sat_id_by_date(position=position, year=year, day=day)
    product_id = "GLM-L2-LCFA" 
    ...
    for h in hours_to_process:
        ...
        nc_candidates = sorted(list(selected_folder_raw.rglob("*LCFA*.nc")))
        ...
        for nc_file in nc_candidates:
            ...
            try:
                run_runner_GLM_L2_LCFA_fnp01(nc_path=str(nc_file), overwrite = overwrite)
...
if __name__ == "__main__":
    print("\n" + " Run  Day-Hour FNP01: GLM_L2_LCFA RUNNER (MULTI-HOUR) ".center(80, "="))
    
    try:
        # Configuration for processing
        # Use "ALL" to process all 24 hour-folders or a specific hour string (e.g., "12")
        run_day_hour_GLM_L2_LCFA_fnp01(
            position = "EAST", 
            year     = "2026", 
            day      = "003", 
            hour     = "ALL"
