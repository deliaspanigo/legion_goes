"""
Path: legion_goes/pycode_actions/pack01/a03_processing/sp001_single/f02_runners/ABI_L2_LSTF/runner_ABI_L2_LSTF_fnp01.py
Version: 0.0.4
Description: Runner - Land Surface Temperature with explicit data_proc path and final output validation.
Last modification: 20-05-2026
"""
# ========================================================================================================================================
#  Execution:
#  python -m legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_LSTF.runner_ABI_L2_LSTF_fnp01
# ========================================================================================================================================
...
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f01_code.ABI_L2_LSTF.proc_ABI_L2_LSTF_fnp01 import (
    gen_dict_output_file_name,
    run_proc_ABI_L2_LSTF_fnp01,
)
...
def run_runner_ABI_L2_LSTF_fnp01(nc_path, str_folder_path_data_proc=None, overwrite=False):
    """
...
if __name__ == "__main__":
    print("\n" + " Runner LSTF FNP01: DIAGNOSTIC TEST ".center(80, "="))
