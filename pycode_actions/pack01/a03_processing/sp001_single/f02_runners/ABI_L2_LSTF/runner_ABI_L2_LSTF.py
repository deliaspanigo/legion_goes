...
Sentence: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_LSTF.runner_ABI_L2_LSTF
...
def gen_str_folder_output(nc_path):
    ...
    # Estructura: data_proc / sp01_single / ABI-L2-LSTF / 2026 / 003 / 12 / 2026003120023 / fnp01
    str_output_folder = (
        Path("data_proc") / 
        "sp01_single" / 
        str_bucket /
...
def run_runner_ABI_L2_LSTF_fnp01(nc_path):
    ...
    # Ejecutar
    run_proc_ABI_L2_LSTF_fnp01(nc_path = nc_path, **dict_path_output)
...
if __name__ == "__main__":
    ...
    if not nc_candidates:
        ...
        # Ejecutar
        run_runner_ABI_L2_LSTF_fnp01(nc_path=str(target_nc))
        print("-" * 80 + "\n✅ TEST FINALIZADO\n" + "=" * 80)
