"""
Path: legion_goes/pycode_actions/pack01/a03_processing/sp001_single/f02_runners/GLM_L2_LCFA/runner_GLM_L2_LCFA.py
Version: 0.0.2
Description: Runner - Land Surface Temperature with Universal Path Detection.
Last modification: 05-05-2026 18:18
"""
# ========================================================================================================================================
#  Execution: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.GLM_L2_LCFA.runner_GLM_L2_LCFA_fnp01
# ========================================================================================================================================
...
# Local libraries
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f01_code.GLM_L2_LCFA.proc_GLM_L2_LCFA_fnp01 import gen_dict_output_file_name 
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f01_code.GLM_L2_LCFA.proc_GLM_L2_LCFA_fnp01 import run_proc_GLM_L2_LCFA_fnp01
...
def run_runner_GLM_L2_LCFA_fnp01(nc_path, overwrite=False):
    """
    ...
    run_proc_GLM_L2_LCFA_fnp01(nc_path=str(nc_path), **dict_str_paths)
...
if __name__ == "__main__":
    print("\n" + " Runner LCFA FNP01: DIAGNOSTIC TEST ".center(80, "="))
    
    # 1. Execution Path
    working_dir = Path.cwd() / "test_one_image"
    
    # 2. Look for the first .nc file containing 'LCFA'
