...
Sentence: python3 -m  legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_MCMIPF.runner_ABI_L2_MCMIPF_fnp01
...
def run_runner_ABI_L2_MCMIPF_fnp01(nc_path):
    ...
    with np.errstate(all='ignore'):
        with warnings.catch_warnings():
            ...
            run_proc_ABI_L2_MCMIPF_fnp01(nc_path=nc_path, **dict_path_output)
...
if __name__ == "__main__":
    ...
    if not nc_candidates:
        ...
        # Ejecutar
        run_runner_ABI_L2_MCMIPF_fnp01(nc_path=str(target_nc))
        print("-" * 80 + "\n✅ TEST FINALIZADO\n" + "=" * 80)
