"""
Path:
legion_goes/pycode_actions/pack01/a03_processing/sp001_single/f03_pipelines/ABI_L2_LSTF/pipeline_ABI_L2_LSTF.py

Version: 0.0.2
Description:
    Pipeline/orquestador para ABI-L2-LSTF.
...
# =========================================================================================================================================
#  Execution:
#  python -m legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f03_pipelines.ABI_L2_LSTF.pipeline_ABI_L2_LSTF
# =========================================================================================================================================
...
from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_LSTF.runner_ABI_L2_LSTF_fnp01 import (
    gen_dict_path_output as gen_dict_path_output_fnp01,
    run_runner_ABI_L2_LSTF_fnp01,
)

from legion_goes.pycode_actions.pack01.a03_processing.sp001_single.f02_runners.ABI_L2_LSTF.runner_ABI_L2_LSTF_fnp02 import (
    gen_dict_path_output as gen_dict_path_output_fnp02,
    run_runner_ABI_L2_LSTF_fnp02,
)
...
def parse_goes_nc_file(nc_path) -> Dict[str, str]:
    ...
    Example:
    OR_ABI-L2-LSTF-M6_G19_s20260031200230_e20260031209539_c20260031214569.nc
    """
...
def gen_timestamp_folder(nc_path, data_proc_dir) -> Path:
    ...
    data_proc/sp01_single/noaa-goes19-EAST/ABI-L2-LSTF/YYYY/DDD/HH/sYYYYDDDHHMMSS
    """
...
def run_fnp01_for_pipeline(nc_path, data_proc_dir, overwrite=False) -> Dict[str, Any]:
    ...
    try:
        success = run_runner_ABI_L2_LSTF_fnp01(
            nc_path=nc_path,
            str_folder_path_data_proc=data_proc_dir,
            overwrite=overwrite,
        )
...
def run_fnp02_for_pipeline(nc_path, data_proc_dir, overwrite=False) -> Dict[str, Any]:
    ...
    try:
        success = run_runner_ABI_L2_LSTF_fnp02(
            nc_path=nc_path,
            str_folder_path_data_proc=data_proc_dir,
            overwrite=overwrite,
        )
...
def run_pipeline_ABI_L2_LSTF(
    ...
    """
    Orchestrates one or more LSTF FNPs.
...
if __name__ == "__main__":
    ...
    print("\n" + " LSTF PIPELINE: DIAGNOSTIC TEST ".center(80, "="))
    ...
    # -------------------------------------------------------------------------
    # 2. Look recursively for the first .nc file containing 'LSTF'
    # -------------------------------------------------------------------------

    nc_candidates = sorted(list(folder_data_raw.rglob("*LSTF*.nc")))

    if not nc_candidates:

        print(f" Error: No .nc files with 'LSTF' found in: {folder_data_raw}")
        ...
        manifest = run_pipeline_ABI_L2_LSTF(
            nc_path=target_nc,
