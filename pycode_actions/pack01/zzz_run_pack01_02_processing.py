...
def run_pack01_02_processing(position: str, year: str, day: str, hour: str):
    ...
    run_day_hour_ABI_L2_LSTF_fnp01(position=position, year=year, day=day, hour=hour)

    print(f"--- Iniciando Procesamiento: MCMIPF (FNP01) ---")
    run_day_hour_ABI_L2_MCMIPF_fnp01(position=position, year=year, day=day, hour=hour)
    
    print(f"--- Iniciando Procesamiento: MCMIPF (FNP02) ---")
    run_day_hour_ABI_L2_MCMIPF_fnp02(position=position, year=year, day=day, hour=hour)
